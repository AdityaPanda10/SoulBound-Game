...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        animator.SetFloat("magnitude", rb.linearVelocity.magnitude > 0.1 ? 1 : 0);
        ...
        if (!isWallJumping)
        {
            rb.linearVelocity = new Vector2(horizontalMovement * moveSpeed * speedMultiplyer, rb.linearVelocity.y);
            Flip();
        }
    }
